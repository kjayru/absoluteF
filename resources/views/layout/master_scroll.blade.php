...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="/css/main_scroll.css?v={{ uniqid() }}">
    ...
    <body>
        ...
        @desktop
        <script src="/js/main_scroll.js?v={{ uniqid() }}"></script>
        @enddesktop
        @mobile
        <script src="/js/mainmobile_scroll.js?v={{ uniqid() }}"></script>
        @endmobile
        @tablet
        <script src="/js/maintablet_scroll.js?v={{ uniqid() }}"></script>
        @endtablet
